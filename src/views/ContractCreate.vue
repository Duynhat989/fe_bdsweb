...
<template>
    <div class="create-contract">
        ...
        <p style="color: white;">Lưu ý: <i style="font-size: 12px;color: red;">Đây là giải pháp tham khảo nhằm mục đích tối ưu quá trình tạo hợp đồng 1 cách nhanh nhất. Vui lòng chỉ sử dụng để tham khảo, chúng tôi không chịu trách nhiệm nếu bạn sử dụng trực tiếp với mục đích thương mại.</i></p>
